...
bin_size, number_of_instances, dict = firstFitDecreasing.readInInstances(path + "instance1\instance0.txt")
...
for i in range (1):
    bin_size, number_of_instances, dict = firstFitDecreasing.readInInstances(path + "instance1\instance" +str(i)+ ".txt")
    print(len(firstFitDecreasing.first_fit_decreasing_algorithm(dict, bin_size, return_sizes=True)))
